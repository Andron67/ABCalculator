...
lblConversion1 = tk.Label(text = "Конверсия", font = ('Helvetica', 10, 'bold'))
lblConversion1.place(x = 25, y = 115)

entConversion1 = tk.Entry(font = ('Helvetica', 10, 'bold'))
entConversion1.place(x = 115, y = 115, width = 120, height = 20)
...
lblVisitors2.place(x = 115, y = 175, width = 120, height = 20)

lblConversion2 = tk.Label(text = "Конверсия", font = ('Helvetica', 10, 'bold'))
lblConversion2.place(x = 25, y = 205)

lblConversion2 = tk.Entry(font = ('Helvetica', 10, 'bold'))
lblConversion2.place(x = 115, y = 205, width = 120, height = 20)
